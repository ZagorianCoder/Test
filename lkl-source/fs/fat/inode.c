...
{
	printk(KERN_INFO "Writing pages");
	return mpage_writepages(mapping, wbc, fat_get_block);
}

static int fat_readpage(struct file *file, struct page *page)
{
	printk(KERN_INFO "Reading page");
...
{
	printk(KERN_INFO "Reading of pages started");
...
static void fat_write_failed(struct address_space *mapping, loff_t to)
{
	...
	printk(KERN_INFO "Write has failed");
	if (to > inode->i_size) {
...
{
	int err;
	printk(KERN_INFO "write_begin has started");
			...
			struct page *pagep, void *fsdata)
{
	...
	printk(KERN_INFO "write_end has started its execution");
	if (err < len)
		fat_write_failed(mapping, pos + len);
...
static ssize_t fat_direct_IO(struct kiocb *iocb, struct iov_iter *iter)
{
	...
	printk(KERN_INFO "fat_direct_IO successfully executed");
	return ret;
}
...
static sector_t _fat_bmap(struct address_space *mapping, sector_t block)
{
	...
	printk(KERN_INFO "fat_bmap execution completed");
	return blocknr;
}
...
static void fat_evict_inode(struct inode *inode)
{
	...
	fat_detach(inode);
	printk(KERN_INFO "FEI procedure carried out");
}
...
static void fat_put_super(struct super_block *sb)
{
	...
	printk(KERN_INFO "fat put super: execution completed");
}
...
static struct inode *fat_alloc_inode(struct super_block *sb)
{
	...
	printk(KERN_INFO "FAI successfully executed");
	return &ei->vfs_inode;
}
...
static void fat_destroy_inode(struct inode *inode)
{
	...
	printk(KERN_INFO "inode destroyed");
}
...
static int fat_remount(struct super_block *sb, int *flags, char *data)
{
	...
	*flags |= MS_NODIRATIME | (sbi->options.isvfat ? 0 : MS_NOATIME);
	...
	printk(KERN_INFO "Remount has been completed");
	return 0;
}
...
static int fat_statfs(struct dentry *dentry, struct kstatfs *buf)
{
	...
	printk(KERN_INFO "Fat_statfs reached the end successfully");
	return 0;
}
...
static int __fat_write_inode(struct inode *inode, int wait)
{
	...
	printk(KERN_INFO "fat_write_inode is now being executed");
	if (inode->i_ino == MSDOS_ROOT_INO)
		return 0;
...
static int fat_write_inode(struct inode *inode, struct writeback_control *wbc)
{
	...
	printk(KERN_INFO "FWI successfully executed");
	return err;
}
...
static int fat_show_options(struct seq_file *m, struct dentry *root)
{
	...
	printk(KERN_INFO "show_options carried out successfully");
	return 0;
}
